    ...
    return (
        <footer className="bg-[#A68966] pt-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-16 relative z-10">
                <div className="bg-maroon rounded-sm overflow-hidden shadow-[0_50px_100px_-20px_rgba(76,13,2,0.6)] mb-20 relative group">
                    {/* Background Pattern */}
                    ...
                    <div className="flex flex-col items-center text-center py-24 px-8 relative z-10">
                        <motion.h2
                            initial={{ opacity: 0, scale: 0.9 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
                            className="text-4xl md:text-6xl lg:text-7xl font-serif text-cream uppercase leading-tight mb-8"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-cream/50 max-w-2xl text-[10px] md:text-xs uppercase tracking-[0.3em] leading-relaxed mb-12 font-light"
                        >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center gap-6 border border-cream/30 bg-maroon/40 backdrop-blur-xl px-12 py-6 rounded-none hover:bg-cream transition-all duration-500 group/btn"
                        >
                        ...
                        <motion.div
                            ...
                            className="mt-20 w-full max-w-5xl aspect-video md:aspect-[21/9] overflow-hidden rounded-sm border-4 border-cream/10 shadow-2xl relative"
                        >
                            <img
                                src={togetherImg}
                                alt="The Collective"
            ...
            {/* Bottom Brand Bar */}
            <div className="bg-maroon text-cream py-16 px-6 md:px-16 border-t border-cream/5 relative z-10 overflow-hidden">
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-20 relative">
                        ...
                        <div className="hidden lg:flex flex-col items-center">
                            <span className="text-8xl md:text-9xl font-serif leading-none mt-[-20px] mb-[-20px]">H</span>
                        </div>
                    </div>

                    <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-12 border-t border-cream/10 pt-12">
                        ...
                        <div className="flex flex-col items-center md:items-end gap-6 text-center md:text-right w-full md:w-auto">
                            <div className="flex flex-wrap justify-center md:justify-end gap-6 lg:gap-12 text-[9px] md:text-[10px] tracking-[0.2em] font-light opacity-60 uppercase">
